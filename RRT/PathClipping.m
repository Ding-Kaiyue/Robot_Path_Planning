...
while q_end.parent ~= 0
    ...
    && noCollision(q_end.coord, nodes(nodes(q_end.parent).parent).coord, obstacle1) ...
    && noCollision(q_end.coord, nodes(nodes(q_end.parent).parent).coord, obstacle2) ...
    && noCollision(q_end.coord, nodes(nodes(q_end.parent).parent).coord, obstacle3) 
